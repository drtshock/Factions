...
public class CmdDisband extends FCommand {
    ...
    public void perform() {
        ...
        if (Conf.logFactionDisband)
            FactionsPlugin.plugin.log("The faction " + faction.getTag() + " (" + faction.getId() + ") was disbanded by " + (senderIsConsole ? "console command" : fme.getName()) + ".");
        ...
        if (Econ.shouldBeUsed() && !senderIsConsole) {
            ...
            if (amount > 0.0) {
                ...
                FactionsPlugin.plugin.log(fme.getName() + " has been given bank holdings of " + amountString + " from disbanding " + faction.getTag() + ".");
            }
        }
